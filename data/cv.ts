...
export const cvData: CVData = {
  ...
  summary:
    "Software engineer yang berfokus pada pengembangan produk bertenaga AI dan aplikasi web full stack. Berpengalaman menggunakan Go, React, dan PostgreSQL dengan ketertarikan mendalam pada arsitektur yang bersih dan pengalaman pengguna yang menyenangkan.",
  location: "Indonesia",
